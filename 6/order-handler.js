...
function updateOrderDisplay() {
    ...
    if (selectedDishes.soup) {
        orderHTML += `
            <div class="order-category" data-category="soup">
    ...
    if (selectedDishes.main) {
        orderHTML += `
            <div class="order-category" data-category="main">
    ...
    if (selectedDishes.salad) {
        orderHTML += `
            <div class="order-category" data-category="salad">
    ...
    if (selectedDishes.drink) {
        orderHTML += `
            <div class="order-category" data-category="drink">
    ...
    if (selectedDishes.dessert) {
        orderHTML += `
            <div class="order-category" data-category="dessert">
